...
- 技术栈： vue3 + vue-router + vuex + typescript
- 请求封装：Axios
- 三方Ui库：ant-design-vue.
- 提交规范:git cz commitizen
- 版本更改历史: changelog
- 文档工具:typedoc
- 代码检查:使用蓝湖统一风格（详见：https://gitlab.lanhuapp.com/lanhu/eslint-config-lanhu/blob/master/vue.js）,
格式化:prettier.提交之前检查与修复：lint-staged
- 测试用例:mocha,ts-node
